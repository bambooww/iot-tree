...
String cptp = ConnProLocPrjMap.TP;
ConnProLocPrjMap cp = (ConnProLocPrjMap)ConnManager.getInstance().getConnProviderById(repid, cpid);
if(cp==null)
{
...
if(cid==null)
	cid = "" ;
ConnPtLocPrjMap cpt = null ;
if(Convert.isNullOrEmpty(connid))
{
	cpt = new ConnPtLocPrjMap() ;
	connid = cpt.getId() ;
}
else
{
	cpt = (ConnPtLocPrjMap)cp.getConnById(connid) ;
	if(cpt==null)
	{
