...
<%
	...
	PageBlkVTxtDDyn pblk_vd = null ;
	PageBlk pblk = pp.getPageBlk(blkn) ;
	String vtxt = "" ;
	if(pblk!=null && pblk instanceof PageBlkTxt)
	{//no set page blk
		pblk_vd = (PageBlkVTxtDDyn)pblk ;
		vtxt = pblk_vd.getVTxt() ;
	}
%>
<html>
<head>
...
<form class="layui-form" action="" onsubmit="return false;">
  ...
  <div class="layui-form-item" id="cont_desc">
    ...
    <div class="layui-input-inline"  style="width:500px;">
      <textarea id="txt" lay-filter="txt" style="width:480px;height:250px;"><%=vtxt %></textarea>
    </div>
  </div>
