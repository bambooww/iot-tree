<%@ page contentType="text/html;charset=UTF-8"%><%@ page import="java.util.*,
				 ...
				 org.iottree.core.*,
				 org.iottree.core.res.*, org.iottree.portal.*,
...
File dirb = null ;
    ...
    String prjid = pms.get("prjid") ;
    String nf_id = pms.get("nf_id") ;
    
    if(Convert.isNullOrEmpty(prjid))
    {
    	out.print("no prjid input");
    	return;
    }
    if(Convert.isNullOrEmpty(nf_id))
    {
    	out.print("no nf_id input");
    	return;
    }
    
    PortalManager pmgr = PortalManager.getInstanceByPrjId(prjid) ;
    if(pmgr==null){
    	out.print("no PortalManager found") ;
    	return ;
    }
    ...
    File tarf = pmgr.setNavFrameLogoFile(nf_id, fi, failedr) ;
    if(tarf==null)
    {
