...
InfluxDB_ReadByTags node = (InfluxDB_ReadByTags)net.getNodeById(itemid) ;
if(node==null)
{
...
InfluxDB_M mmm = (InfluxDB_M)node.getOwnRelatedModule() ;
List<String> tables = mmm.listBucketMeasurements() ;
if(tables==null)
...
%>
    ...
    <div class="layui-form-mid">Default query time period:</div>
    <div class="layui-input-inline" style="width:100px;">
    	<input id="def_qtp" class="layui-input" type="number" />
    </div>
...
<div id="rules" style="overflow-y:auto;max-height: 480px;">
    ...
    <div class="layui-form-mid"><button onclick="add_rule()" style="border-color:#dddddd">+Add</button></div>
</div>
...
function get_pm_jo()
{
	...
	jo.def_qtp = get_input_val("def_qtp",300000,true)
	jo.m = $("#m").val();
	let rule_jos = [] ;
	jo.tags = rule_jos ;
