...
LLMOllamaChat_NM node = (LLMOllamaChat_NM)net.getNodeById(itemid) ;
if(node==null)
{
...
//String host = node.getOllamaHost() ;
//int port = node.getOllamaPort() ;
...
<div class="layui-form-item">
    <label class="layui-form-label">Ollama Host</label>
    <div class="layui-input-inline" style="width:250px;">
      <input type="text" id="ollama_host" class="layui-input" value="<%=host%>"/>
    </div>
    <div class="layui-form-mid">Port</div>
    <div class="layui-input-inline" style="width:100px;">
      <input type="number" id="ollama_port" class="layui-input" value="<%=port%>"/>
    </div>
  </div>
<div class="layui-form-item">
...
{
%><option value="<%=md.getName() %>"><%=md.getName() %></option>
<%
}
%>
      </select>
...
function get_pm_jo()
{
	...
	let ollama_port = get_input_val("ollama_port",3000,true) ;
	let model_name =  $("#model_name").val();
	
	return {ollama_host:ollama_host,ollama_port:ollama_port,model_name:model_name} ;
}
