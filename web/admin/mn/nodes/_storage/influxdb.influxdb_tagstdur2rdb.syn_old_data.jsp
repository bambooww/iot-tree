...
<%@ page import="java.util.*,
	...
	String tag_path = item.getTagPath() ;
	UATag tag = item.getTag() ;
	InfluxDB_TagStDur2RDB.DurTP dur_tp = item.getDurTP() ;
%>
<html>
<head>
<title></title>
...
if(tag!=null)
{
	String tagt = tag.getNodePathTitle();
%>Tag: <%=tagt%><br><%
}
else
{
%><div style="color:red">no tag found</div><br><%
}
%>
DurTP=<%=dur_tp.getTitle() %><br>
