...
<%@ page import="java.util.*,
	...
	if(item==null || !(item instanceof NM_TagFilter2TSDB))
	{
		out.print("no item found") ;
		return ;
	}
	
	NM_TagFilter2TSDB stb_node= (NM_TagFilter2TSDB)item ;
	
	boolean b_all_nor_tag = stb_node.isAllNorTag();
...
%>
 ...
 <div class="layui-form-item">
    ...
    <br><br> <input type="checkbox" id="all_nor_tag" class="layui-input" lay-skin="primary" /><br>All Nor Tags
    </div>
...
var b_all_nor_tag = <%=b_all_nor_tag%>;
...
function get_pm_jo()
{
	...
	ret.all_nor_tag = $("#all_nor_tag").prop("checked") ;
	return ret ;
}
...
function set_pm_jo(jo)
{
	...
	b_all_nor_tag = jo.all_nor_tag ;
	tag_paths = jo.tag_paths;
	$("#all_nor_tag").prop("checked",b_all_nor_tag) ;
}
