...
<link rel="stylesheet" href="../mn/inc/mn.css?v=1" />
...
<div id="leftcat_comp" class="show_hid_icon" style="left:0px;" onclick="show_hiddle_left()" title="show or hidden left panel"><i class="fa fa-cogs fa-lg lr_btn"></i><br>&nbsp; </div>
		<div id="left_panel" class="left_panel_win"  >
			<div class="left_panel_bar" >
			 ...
			 <%--
			<iframe id="left_pan_iframe" src="mn_node_list.jsp?container_id=<%="" %>" style="width:100%;top:0px;height:300px;overflow:hidden;margin: 0px;border:0px solid;padding: 0px;" ></iframe>
			 --%>
		</div>
...
function on_item_sel_chg(items)
{
	...
	let item = items[0] ;
	if(item.getClassName()==ot.view.DIModule.CN)
	{
	...
	else if(item.getClassName()==ot.view.DINode.CN)
	{
