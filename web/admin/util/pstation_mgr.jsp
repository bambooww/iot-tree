...
{
	dlg.loading(true);
	send_ajax("pstation_remote_ajax.jsp",{op:"station_syn_dir_diff",stationid:stationid,module:module,path:path},(bsucc,ret)=>{
		dlg.loading(false);
...
function station_syndir_synmon()
{
	...
	send_ajax("pstation_remote_ajax.jsp",{op:"station_syn_dir_syn_mon",stationid:c.stationid,module:c.module,path:c.path},(bsucc,ret)=>{
		if(!bsucc)
		{
			dlg.msg(ret) ;
			dlg.loading(false);
...
function show_files()
{
	...
	//console.log(pm)
	send_ajax("pstation_remote_ajax.jsp",pm,(bsucc,ret)=>{
				if(!bsucc || ret.indexOf('[')!=0)
				{
					dlg.msg(ret) ;
					return ;
