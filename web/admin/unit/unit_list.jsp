<%@ page contentType="text/html;charset=UTF-8"%><%@page 
	import="java.io.*,java.util.*,org.iottree.user.*,org.iottree.system.*
...
function add_unit()
{
	window.open("unit_edit.jsp?unitid="+oc.util.create_new_tmp_id());
}
...
{
	send_ajax("unit_ajax.jsp","op=load_all",(bsucc,ret)=>{
		//console.log(bsucc);
		//console.log(ret);
...
{
	window.open("unit_edit.jsp?unitid="+id);
}
