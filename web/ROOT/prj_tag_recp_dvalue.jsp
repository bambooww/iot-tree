...
%><%
if(!Convert.checkReqEmpty(request, out, "prjid","proid"))
	return ;
...
{
	out.print("no tag input or found") ;
	return ;
}
...
{
	page_last_dt=-1 ;
	show_list("prj_tag_recp_dvalue_ajax.jsp",{prjid:prjid,tag:tagpath,proid:proid,page_last_dt:-1},false) ;
}


function show_list_more() {
	//page_idx++ ;
	show_list("prj_tag_recp_dvalue_ajax.jsp",{prjid:prjid,tag:tagpath,proid:proid,page_last_dt:page_last_dt},true) ; 
}
