...
public class DrvNamespace extends ManagedNamespace
{
	public static final String NAMESPACE_URI = "urn:iottree:drv:drv1";
	...
	DrvNamespace(OpcUaServer server)
	{
	...
	private void addCustomObjectTypeAndInstance(UaFolderNode rootFolder)
	{
		...
		// "instance declarations" by the spec.
