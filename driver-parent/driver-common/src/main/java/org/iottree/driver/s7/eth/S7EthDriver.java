...
{
	public static final String DRIVER_NAME = "s7_tcpip_eth";
	...
	final private static List<Model> devms = Arrays.asList(new S7Model_200(M_S7_200, "S7-200"),
			new S7Model_300__1500(M_S7_200_SMART, "S7-200 SMART"), // S7_200_smart,
			new S7Model_300__1500(M_S7_300, "S7-300"), new S7Model_300__1500(M_S7_400, "S7-400"), new S7Model_300__1500(M_S7_1200, "S7-1200"),
			new S7Model_300__1500(M_S7_1500, "S7-1500"));
	...
	public List<PropGroup> getPropGroupsForDevInCh(UADev d)
	{
		...
		PropGroup gp_nor = new PropGroup("s7_comm_pm", lan);// "S7 Communication
															// Parameters");
		// PropItem pi = new PropItem("link_tp","Link
		// Type","",PValTP.vt_int,false,new String[] {"PC","OP","PG"},new
		// Object[] {false,true},false));

		PropItem pi_rack = new PropItem("rack", lan, PValTP.vt_int, false, null, null, 0); // "CPU
																							// Rack",""
		...
		PropItem pi_slot = new PropItem("slot", lan, PValTP.vt_int, false, null, null, 1); // "CPU
																							// Slot",""
		...
		PropGroup gp_tsap = new PropGroup("s7_comm_pm", lan);// "S7
																// Communication
																// Parameters");
		PropItem pi_local_tsap = new PropItem("tsap_local", lan, PValTP.vt_str, false, null, null, "4D57"); // "Local
																											// TSAP
																											// (hex)",""
		pi_local_tsap.setValChker(tsapchk);
		gp_tsap.addPropItem(pi_local_tsap);
		PropItem pi_remote_tsap = new PropItem("tsap_remote", lan, PValTP.vt_str, false, null, null, "4D57"); // "Remote
																												// TSAP
																												// (hex)",""
	...
	public boolean RT_writeVal(UACh ch, UADev dev, UATag tag, DevAddr da, Object v)
	{
		...
		if (!r)
		{
			if (log.isDebugEnabled())
				log.debug("S7EthDriver " + failedr.toString());
		}
		return r;
	}
