...
public class FinsAddrSeg implements IAddrDefSeg
{
	String title ;
	...
	transient FinsAddrDef belongTo ;
	
	FinsAddrSeg(String title,int valstart,int valend,int digit_num,UAVal.ValTP[] tps)
	{
		this.title = title ;
...
//		this.bHasBit = b_hasbit ;
	...
	public FinsAddrSeg asWrite(boolean bw)
	{
		this.bWrite = bw ;
		return this;
	}
	 ...
	 * @return
	 */
	public FinsAddrSeg asHasSubBit(boolean b)
	{
		this.bHasBit = b ;
		return this;
	}
...
//	}
	...
	public boolean matchAddr(FinsAddr addr)
	{
...
class FinsAddrSegSubBit extends FinsAddrSeg
{
	FinsAddrSegSubBit(FinsAddrSeg seg)
	{
